...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_js_1.User, (user) => user.favorites, { onDelete: 'CASCADE' }),
...
__decorate([
    ...
    __metadata("design:type", String)
], Favorite.prototype, "eventId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => event_entity_js_1.Event, (event) => event.favorites, { onDelete: 'CASCADE' }),
